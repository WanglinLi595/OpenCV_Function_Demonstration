...
class Ui_main_interface(object):
    def setupUi(self, main_interface):
        ...
        self.actionexit = QAction(main_interface)
        ...
        self.tree_widget.setGeometry(QRect(950, 10, 256, 771))
        self.tableWidget = QTableWidget(self.centralwidget)
        self.tableWidget.setObjectName(u"tableWidget")
        self.tableWidget.setGeometry(QRect(250, 10, 701, 771))
    ...
    def retranslateUi(self, main_interface):
        ...
        self.actionexit.setText(QCoreApplication.translate("main_interface", u"\u9000\u51fa", None))
#if QT_CONFIG(tooltip)
        self.actionexit.setToolTip(QCoreApplication.translate("main_interface", u"\u9000\u51fa\u7a0b\u5e8f", None))
